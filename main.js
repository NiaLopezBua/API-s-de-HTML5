if (window.File && window.FileReader && window.FileList && window.Blob) {
    function handleFileSelect(evt) {
      ...
      reader.onload = (function (theFile) {
        return function (e) {
          ...
          loadingMessage.innerHTML = "Cargando video, esto puede tardar unos minutos...";
          ...
          document
            ...
            .addEventListener("canplay", () => {
              ...
              }, 10000); // Para mostrar el mensaje de carga durante 10 segundos, utilizando setTimeout //
            });
        };
      })(file);
    ...
    alert("El navegador no soporta este tipo de archivo.");
  }
